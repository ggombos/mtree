...
-- CREATE INDEX millionSong_gist_index ON millionSong USING gist (tags mtree_text_array_opclass(distancestrategy='weighted_text_array_distance',picksplitstrategy="FirstTwo")) ;
