DROP INDEX IF EXISTS Fingerprint_10_GiST_Mtree CASCADE;
CREATE INDEX Fingerprint_10_GiST_Mtree ON Fingerprint_10 USING GiST (hash_gist mtree_text_opclass);
