...
CREATE TABLE fingerprints2 (
  ...
  hash	TEXT,
  offset2  INTEGER,
  hash_gist mtree_text_array
);

\copy fingerprints2 FROM '/home/ggombos/mtree/mtree_gist/data/fingerprint_data_array_10';

CREATE INDEX fingerprint2_gist_index ON fingerprints2 USING gist (hash_gist mtree_text_array_opclass) ;
